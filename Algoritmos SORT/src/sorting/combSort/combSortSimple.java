...
public class combSortSimple <T extends Comparable<T>> extends AbstractSorting<T> {
    ...
    public static void main(String[] args) {
        combSortSimple cns = new combSortSimple<Integer>();
...
//      Integer[] array = {-1577,1000,-1700,101,1238, 2374,43534,1231,6,414};
        cns.sort(array, 0, array.length-1);
